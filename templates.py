...
class TextboxBaseTemplate:
    ...
    def add_base_textbox(self, slide: pptx_slide, presentation: pptx_presentation):
    ...
    def reset_textbox_position(self, presentation: pptx_presentation):
...
def build_professor_textbox_func(template: TextboxTemplate):
    ...
    def add_professor_name_textbox(slide: pptx_slide, presentation: pptx_presentation, professor_name: str):
...
def build_room_textbox_func(template: TextboxTemplate):
    """Return a function to format, add, and return a textbox formatted for a room number"""
    base_template = TextboxBaseTemplate(template)

    def add_room_number_textbox(slide: pptx_slide, presentation: pptx_presentation, room_number: str):
        """Add to slide and then return a default formatted textbox"""
        textbox = base_template.add_base_textbox(slide, presentation)
